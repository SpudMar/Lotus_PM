...
import { terminateServiceAgreement } from '@/lib/modules/service-agreements/service-agreements'
...
export async function POST(
  ...
  try {
    ...
    const updated = await terminateServiceAgreement(id, session.user.id)
